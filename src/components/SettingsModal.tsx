          ...
          <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-transparent relative overflow-hidden">
              ...
              <div className="block">
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder={activeProfile.apiKey ? '已保存，输入新值可覆盖' : 'sk-...'}
                ...
                <div className="mt-1.5 text-xs text-gray-500 dark:text-gray-500">
                  已保存的密钥不会回显；如需修改，请直接输入新的 API Key 覆盖。
                </div>
              </div>
            ...
            {activeTab === 'about' && (
              <div className="flex h-full min-h-[300px] flex-col items-center justify-center pb-8 px-6">
                {}
                <a
                  href="https://github.com/YA52077/GPT-IMAGE-P"
                  target="_blank"
                ...
                >
                  ...
                  <h4 className="text-[17px] font-bold text-gray-800 dark:text-gray-100">GPT绘图</h4>
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <a
                    href="https://github.com/YA52077/GPT-IMAGE-P/issues"
                    target="_blank"
                    rel="noopener noreferrer"
